...
public class ResponseFollowing implements Parcelable {
    ...
    public final static Creator<ResponseFollowing> CREATOR = new Creator<ResponseFollowing>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ResponseFollowing createFromParcel(Parcel in) {
            ResponseFollowing instance = new ResponseFollowing();
        ...
        public ResponseFollowing[] newArray(int size) {
            return (new ResponseFollowing[size]);
        }
